...
// Compact group header that separates related cards without shouting. Matches
// the muted micro-caps pattern used elsewhere (e.g. done-section on the free
// session). First-group has `first` so it doesn't push the page down.
...
export function Settings({ uid, navigate, onLogout }: Props) {
  ...
  return (
    <div className="page-bg min-h-screen">
      ...
      {/* Week order — only relevant to the training week grid on Home. Lives
          under אימונים settings only; food settings do not show this. */}
      <div className="card mb-4">
      ...
      {/* Always here — reaching a human should not be something you have to
          get locked out to find. Trial status moved to חשבון below. */}
      <ContactCard />
